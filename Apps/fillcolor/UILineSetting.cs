...
public class UILineSetting : ScriptBase
{
    ...
    void LayoutChild()
    {
        ...
        if (!Device.isLandscape)
        {
            ...
            Vector2 sizeDelta = rctran.sizeDelta;
            float ofty = Common.ScreenToCanvasHeigt(sizeCanvas, Device.offsetTop);
            rctran.offsetMax = new Vector2(rctran.offsetMax.x, -16 - ofty);
