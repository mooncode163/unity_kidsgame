...
public class UIColorInput : UIView
{
    ...
    void Awake()
    {
        ...
        {
            EventColorInputImage eventImage = imageColorG_B.GetComponent<EventColorInputImage>();
        ...
        {
            EventColorInputImage eventImage = imageColorRed.GetComponent<EventColorInputImage>();
