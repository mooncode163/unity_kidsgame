...
public class UIGameWinPintu : UIGameWinBase, ISegmentDelegate
{
    ...
    public override void LayOut()
    {
        ...
        // Debug.Log("UIGameWinPintu:i   w=" + w + " h=" + h);

        // LayOutHorizontal lg = objLayoutBtn.GetComponent<LayOutHorizontal>();
        // lg.LayOut();
        // base.LayOut();
    ...
    public void ShowDetail()
    {
        ...
        string strPrefab = ConfigPrefab.main.GetPrefab("UIWordDetaiPintu");
    ...
    {
        Close();
        if (MoreGameViewController.main.currentGameId == MoreGameRes.PINTU)
        {

            PintuViewController.main.GotoNextLevel();

        }
        if (MoreGameViewController.main.currentGameId == MoreGameRes.MATCH)
        {

            MatchViewController.main.GotoNextLevel();
