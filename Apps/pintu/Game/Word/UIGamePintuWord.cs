...
public class UIGamePintuWord : UIGameBase, IGamePintuWordDelegate
{
    ...
    public static Texture2D texBgGamePic
    {
        get
        {
            return TextureCache.main.LoadImageKey("WordBg");
    ...
    void LoadGameTexture()
    {
        ...
        string pic = strDirRoot + infoWord.id + "/" + infoWord.id + ".png";
        // texGamePic = LoadTexture.LoadFromAsset(pic);
        texGamePic = TextureCache.main.LoadImageKey("WordBg");
        UpdateGameTexture();
    }
    ...
    void UpdateGameTexture()
    {
        ...
        gamePintuWord.UpdateGameImageBg(texBgGamePic);
        gamePintuWord.UpdateTexture(texGamePic);
    ...
    public override void LayOut()
    {
        ...
        if (gamePintuWord != null)
        {
            gamePintuWord.LayOut(false);
        }
    ...
    void OnGameWin()
    {
        ...
        string strPrefabDefault = "App/Prefab/Game/GameFinish/UIGameWinWord";
        string strPrefab = "AppCommon/Prefab/Game/GameFinish/UIGameWin" + infoPlace.gameId;
        Debug.Log("GameWin strPrefab=" + strPrefab);
        if (PrefabCache.main.Load(strPrefab) == null)
        {
    ...
    void OnGameFail()
    {
        WordItemInfo info = GameLevelParse.main.GetItemInfo() as WordItemInfo;
        ItemInfo infoPlace = LevelManager.main.GetPlaceItemInfo(LevelManager.main.placeLevel);
        string strPrefab = "AppCommon/Prefab/Game/GameFinish/UIGameFail";
        PopUpManager.main.Show<UIGameWinBase>(strPrefab, popup =>
        {
            Debug.Log("UIGameWinBase Open ");
            popup.UpdateItem(info);
    ...
    public override void UpdateGuankaLevel(int level)
    {
        ...
        gamePintuWord = objgame.AddComponent<GamePintuWord>();
        gamePintuWord.iDelegate = this;

        gamePintuWord.infoGuankaItem = info;
        gamePintuWord.CreateBlock();
        AppSceneBase.main.AddObjToMainWorld(objgame);
        gamePintuWord.transform.localPosition = new Vector3(0, 0, -1f);
    ...
    public void OnGamePintuWordDidBack(GamePintuWord ui)
    {
        OnClickBtnBack();
    }
    public void OnGamePintuWordDidGameWin(GamePintuWord ui)
    {
        OnGameWin();
    }
    public void OnGamePintuWordDidGameFail(GamePintuWord ui)
    {
        OnGameFail();
    }

    public void OnGamePintuWordDidNextLevel(GamePintuWord ui)
    {
