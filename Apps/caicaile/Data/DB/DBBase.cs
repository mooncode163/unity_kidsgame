...
public class IdiomItemInfo : DBItemInfoBase
{
...
public class DBInfoXiehouyu : DBItemInfoBase
{
     public string id;
    public string head;
    public string end;
...
public class DBInfoRiddle : DBItemInfoBase
{
    public string id;
    public string head;
    public string end;
...
public class DBBase
{
    ...
    // public List<DBItemInfoBase> GetAllItem()
    // {
    //     // Distinct 去掉重复
    //     //desc 降序 asc 升序 
    ...
    //         return new T();
    //     }
    public List<DBItemInfoBase> GetAllDate()
    {
        // Distinct 去掉重复
        //desc 降序 asc 升序 
    ...
    public List<DBItemInfoBase> GetItemByDate(string date)
    {
    ...
    public void GetItemById(DBItemInfoBase info, string id)
    {
        string strsql = "select * from " + TABLE_NAME + " where id = '" + id + "'";
    ...
    public void GetItemByTitle(DBItemInfoBase info, string title)
    {
