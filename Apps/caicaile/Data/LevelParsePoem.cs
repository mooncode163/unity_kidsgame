...
public class LevelParsePoem : GameLevelParseBase
{
    static private LevelParsePoem _main = null;
    public static LevelParsePoem main
    {
        get
        {
            if (_main == null)
            {
                _main = new LevelParsePoem();
            }
            return _main;
        }
    }
    ...
    public override void ParseItem(CaiCaiLeItemInfo info)
    {
        ...
        // {
        //     dbInfo = DBIdiom.main.GetItemByTitle(info.id);
